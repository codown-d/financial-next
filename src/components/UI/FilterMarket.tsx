...
export default function FilterMarket(props: { type: "service" | "credit" }) {
  ...
  return (
    <div>
      <div className="mb-2 mt-1 ml-3 text-[#999]">共{MarketDataList.length}条结果</div>
      <FilterHeader className={'!mb-3'} left={'产品列表' } right={<TzForm layout={"inline"} form={form} onValuesChange={(changedValues, allValues)=>{
