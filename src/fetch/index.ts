...
export const getServerSidePolicyList = async (
  params
...
export const getServicePolicy = async (
  params?: any
): Promise<IResponseData<any>> => {
...
export const enterpriseVerify = async (
  params?: any
): Promise<IResponseData<any>> => {
...
export const productRecommend = async (
  params?: any
): Promise<IResponseData<any>> => {
...
export const productApply = async (
  params?: any
): Promise<IResponseData<any>> => {
...
export const financeList = async (
  params?: any
): Promise<IResponseData<FinanceItemProps>> => {
...
export const policyStatistics = async (
  params?: any
): Promise<IResponseData<FinanceItemProps>> => {
  return http.get(`${api.policyStatistics}`, params);
};
export const themeFeature = async (
  params?: any
): Promise<IResponseData<FinanceItemProps>> => {
